...
def get_cameras_in_radius(token, center, radius):
    # Assumes center is in the format "latitude|longitude"
    # center = "47.636521|-122.321498"
    # radius = 200
    url = f"https://na-api.beta.inrix.com/Traffic/Inrix.ashx?action=GetTrafficCamerasInRadius&locale=en-US&center={center}&radius={radius}&token={token}"
